        ...
        <footer className="footer custom-footer row p-3 text-center border-top bg-dark">
            <div className="d-flex justify-content-center mb-2">
                <h6 className="m-0 p-0">
                    ...
                    style="height:22px!important;margin-left:3px;vertical-align:text-bottom;"
                    src="images/icons/nd.svg" alt=""/></a></h6>
            </div>
            <small className="m-0 p-0 text-muted">El dominio orignal de miarma.net es <strong
                style="color: tomato;">ÚNICO</strong> y es
                <strong style="color: tomato;">ESTE</strong>. No nos hacemos responsables de posibles copias
